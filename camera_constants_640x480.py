...
CAMERA_FX = 554.256258  # Focal length X (pixels)
CAMERA_FY = 554.256258  # Focal length Y (pixels)
CAMERA_CX = 320.000000  # Principal point X (pixels)
CAMERA_CY = 240.000000  # Principal point Y (pixels)
